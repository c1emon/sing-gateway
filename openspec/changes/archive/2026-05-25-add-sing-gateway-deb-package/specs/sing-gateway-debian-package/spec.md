...
The package SHALL install `sing-gateway` as a Debian companion package for sing-box without enabling gateway integration or mutating host network state during installation.
